...
<script>
	function checking() {
		...
		else if (document.writeForm.bpwd.value == "")
			alert("Please enter your PASSWORD");
		else if (document.writeForm.bpwd.value != document.writeForm.rebpwd.value)
			alert("Wrong PASSWORD");
		else if (document.writeForm.age.value == "")
			alert("Please check your SEX");
		else if (document.writeForm.nation.value == "nation")
			alert("Please choose your NATION");
		else
...
<link
	href="${pageContext.request.contextPath}/content/joinus/css/reset.css"
	style="text/css" rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/content/joinus/css/logindetail.css"
	style="text/css" rel="stylesheet">
</head>
<body id="abody">
	<div id="beta"></div>
			...
			<div id="box">
				...
				<div id="center">
					<form action="login" method="post" name="writeForm">
						<div id="one">
							<input type="email" placeholder="       E-MAIL ADDRESS" id="t"
								name="email">
						</div>
						<div id="two">
							<input type="password" placeholder="       PASSWORD" id="t"
								name="bpwd">
						</div>
						<div id="three">
						...
						<div id="five">
							<input type="text" placeholder="       AGE" name="age" id="t">
						</div>
						<div id="six">
						...
						<div id="seven">
							<input type="text" id="t" placeholder="qu1" name="q1">
						</div>
						<div id="eight">
							<input type="text" id="t" placeholder="qu2" name="q2">
						</div>
						<div id="nine">
							<input type="text" id="t" placeholder="qu3" name="q3">
						</div>
						<div id="ten">
